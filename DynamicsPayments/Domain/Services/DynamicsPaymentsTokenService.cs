...
{
    public class DynamicsPaymentsTokenService : IDynamicsPaymentsTokenService
    {
        ...
        public DynamicsPaymentsTokenService(HttpClient dynamicsPaymentsHttpClient, IDynamicsPaymentsConfigurationService dynamicsPaymentsConfigurationService, IDynamicsPaymentsHttpRequestMessageContent httpRequestMessageContent)
        {
