...
using DynamicsPayments.Client.Resources;
...
{
    public class DynamicsPaymentsTransactionService : IDynamicsPaymentsTransactionService
    {
        private readonly IDynamicsPaymentsClient _dynamicsPaymentsClient;
        ...
        public DynamicsPaymentsTransactionService(IDynamicsPaymentsConfigurationService dynamicsPaymentsConfigurationService, HttpClient dynamicsPaymentsHttpClient, IDynamicsPaymentsHttpRequestMessageContent httpRequestMessageContent)
        {
            _dynamicsPaymentsClient = new DynamicsPaymentsClient(dynamicsPaymentsHttpClient, _dynamicsPaymentsConfigurationService.GetDynamicsPaymentsConfiguration().Url.ToString()); ;
