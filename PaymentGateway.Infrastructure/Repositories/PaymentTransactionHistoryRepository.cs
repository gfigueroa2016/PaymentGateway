...
namespace PaymentGateway.Infrastructure.Repositories
{
    public class PaymentTransactionHistoryRepository : IPaymentTransactionHistoryRepository
    {
        ...
        public async Task<IEnumerable<PaymentTransactionHistory>> GetPaymentTransactionHistoryHoldAsync()
        {
            return await _paymentGatewayContext.PaymentTransactionsHistory.Where(p => p.ReserveFunds == true).AsNoTracking().ToListAsync();
        }
